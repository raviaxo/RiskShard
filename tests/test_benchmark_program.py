...
class BenchmarkProgramTests(unittest.TestCase):
    def test_benchmark_program_tracks_thirty_targets_without_overclaiming(self):
        ...
        self.assertEqual(report["module_seeded_count"], 6)
        self.assertEqual(report["benchmark_ready_count"], 1)
        self.assertEqual(report["status_counts"]["missing_module"], 24)
    ...
    def test_seeded_cohort_report_ranks_large_upgrade_work(self):
        ...
        self.assertEqual(cohort["target_count"], 6)
        ...
        self.assertEqual(cohort["upgrade_queue"][0]["id"], "ca_finance_data_breach_midmarket")
        self.assertEqual(cohort["upgrade_queue"][0]["blocker_count"], 7)
        self.assertEqual(by_id["ca_finance_data_breach_midmarket"]["metrics"]["source_backed_parameters"], 5)
