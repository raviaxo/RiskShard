...
class BenchmarkProgramTests(unittest.TestCase):
    ...
    def test_seeded_cohort_report_ranks_large_upgrade_work(self):
        ...
        self.assertEqual(cohort["upgrade_queue"][0]["id"], "jp_manufacturing_ransomware_midmarket")
        ...
        self.assertEqual(by_id["au_finance_bec_midmarket"]["metrics"]["source_backed_parameters"], 4)
    ...
    def test_seeded_sprint_report_groups_actionable_upgrade_work(self):
        ...
        self.assertEqual(sprint["total_blocker_count"], 74)
