...
- [S1_BACKTEST_FINDING.md](S1_BACKTEST_FINDING.md): the S1 backtest result (GB/US finance data-breach frequency vs. VCDB) and the S2 decision.
- [NB_FREQUENCY_MODEL_PROPOSAL.md](NB_FREQUENCY_MODEL_PROPOSAL.md): proposal (for review) for an overdispersed negative-binomial frequency model, following the S1 finding.
