...
**v0.5.0 cut 2026-08-07 (second session of the day).** Release `2026.08.07-v0.5.0`;
immutable explorer archive under `docs/r/2026.08.07-v0.5.0/`; `RS:` citations re-pinned off
`v0.4.0`. The ledger recorded the ADR-0007 coherence split as **newly measured** (4 coherent
