# DECLINED — emergent risk scenarios (archived 2026-08-19)

> **This was the roadmap from 2026-07-20 to 2026-08-19, and it points the opposite way from
> where the project went.** It proposed building new shard families — AI-as-liability,
> correlated/systemic loss, governance/regulatory loss — on the thesis that the differentiator
> is quantifying what point-tools cannot.
>
> **That thesis is retired.** [ADR-0009](../adr/0009-what-riskshard-is-and-is-not.md) decided
> RiskShard is a governed evidence commons and **not** a CRQ methodology project;
> [ADR-0010](../adr/0010-where-riskshard-stops.md) retired the module-library framing;
> [ADR-0016](../adr/0016-the-audit-is-the-product.md) made the source audit the only growth
> surface. Every scenario below fails the ADR-0009 test — *does this make an existing published
> number more correct, or does it make the method more sophisticated?* They are all the second.
>
> **It is archived rather than deleted because the research is real and the ideas are good.**
> ADR-0009 requires that a declined idea be recorded, not buried. If a defect measured in our own
> data ever demands one of these, it starts here — from a measurement, never from this document's
> reasoning.
>
> The live roadmap is [`docs/ROADMAP.md`](../ROADMAP.md).
