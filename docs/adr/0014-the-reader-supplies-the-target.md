...
- **Status:** Accepted (2026-08-15); **parts 1, 4 and 5 superseded 2026-08-19 by
  ...
  measured across the corpus it had to answer over, answered *"0 of 66"* on 138 of its 215
  combinations, and was retired. The principle below — **fit is meaningless without a stated
  target** — is unchanged and still binding. What failed was the control, not the idea.
- **Date:** 2026-08-15
- **Deciders:** repo owner
